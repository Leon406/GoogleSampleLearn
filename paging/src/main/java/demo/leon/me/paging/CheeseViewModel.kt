...
class CheeseViewModel(app: Application) : AndroidViewModel(app) {
    ...
    val allCheeses = LivePagedListBuilder(
        dao.allCheesesByName(), PagedList.Config.Builder()
            .setPageSize(30).setInitialLoadSizeHint(200).setEnablePlaceholders(true).build()
    ).build()


//        dao.allCheesesByName().toLiveData(
//        PagedList.Config(
//            /**
